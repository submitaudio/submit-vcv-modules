...
struct Reel : Module {
    ...
    void process(const ProcessArgs& args) override {
        ...
        if (playPos >= totalFrames || playPos < 0.0) {
            if (barShiftPending) {
                // 8 gelijke stappen over de hele sample
                // Positie 1-8, stap 0 = begin van sample
...
struct ReelDisplay : Widget {
    ...
    void draw(const DrawArgs& args) override {
        ...
        nvgFillColor(args.vg, nvgRGB(12, 12, 18));
        nvgFill(args.vg);
        ...
        if (!module || !module->fileLoaded) {
            ...
            nvgFillColor(args.vg, nvgRGB(70, 70, 90));
        ...
        // Waveform
        nvgBeginPath(args.vg);
        nvgStrokeColor(args.vg, nvgRGB(40, 160, 90));
        nvgStrokeWidth(args.vg, 1.0f);
        for (int x = 0; x < w; x++) {
        ...
        // Middellijn
        nvgBeginPath(args.vg);
        nvgStrokeColor(args.vg, nvgRGBA(80, 80, 80, 60));
        ...
        nvgBeginPath(args.vg);
        nvgStrokeColor(args.vg, nvgRGBA(255, 200, 50, 230));
...
struct ReelWidget : ModuleWidget {
    ReelWidget(Reel* module) {
        setModule(module);
        setPanel(createPanel(asset::plugin(pluginInstance, "res/Reel.svg")));

        // Waveform display
        ReelDisplay* disp = createWidget<ReelDisplay>(mm2px(Vec(2.f, 4.f)));
        disp->box.size = mm2px(Vec(76.f, 28.f));
        disp->module = module;
        addChild(disp);

        // --- Rij 1: BARS, BPM, SPEED ---
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(13.f, 48.f)), module, Reel::BARS_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(33.f, 48.f)), module, Reel::BPM_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(57.f, 48.f)), module, Reel::SPEED_PARAM));

        // --- Rij 2: SYNC, REVERSE, CUE schakelaars + RESET knop ---
        addParam(createParamCentered<CKSS>(mm2px(Vec(13.f, 68.f)), module, Reel::SYNC_PARAM));
        addParam(createParamCentered<CKSS>(mm2px(Vec(33.f, 68.f)), module, Reel::REVERSE_PARAM));
        addParam(createParamCentered<CKSS>(mm2px(Vec(57.f, 68.f)), module, Reel::CUE_PARAM));
        addParam(createParamCentered<CKD6>(mm2px(Vec(75.f, 68.f)), module, Reel::RESET_PARAM));
        addParam(createParamCentered<RoundSmallBlackKnob>(mm2px(Vec(75.f, 48.f)), module, Reel::BARSHIFT_PARAM));

        // LEDs boven schakelaars
        addChild(createLightCentered<SmallLight<YellowLight>>(mm2px(Vec(13.f, 61.f)), module, Reel::SYNC_LIGHT));
        addChild(createLightCentered<SmallLight<YellowLight>>(mm2px(Vec(33.f, 61.f)), module, Reel::REVERSE_LIGHT));
        addChild(createLightCentered<SmallLight<YellowLight>>(mm2px(Vec(57.f, 61.f)), module, Reel::CUE_LIGHT));

        // --- Rij 3: Inputs ---
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(13.f, 88.f)), module, Reel::CLOCK_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(33.f, 88.f)), module, Reel::TRIG_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(57.f, 88.f)), module, Reel::SPEED_CV_INPUT));

        // --- Rij 4: CV inputs ---
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(13.f, 108.f)), module, Reel::BARS_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(25.f, 108.f)), module, Reel::BPM_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(37.f, 108.f)), module, Reel::BARSHIFT_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.f, 108.f)), module, Reel::REVERSE_CV_INPUT));

        // --- Rij 5: Outputs ---
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(13.f, 120.f)), module, Reel::MAIN_L_OUTPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(33.f, 120.f)), module, Reel::MAIN_R_OUTPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(57.f, 120.f)), module, Reel::CUE_OUTPUT));
    }
...
Model* modelReel = createModel<Reel, ReelWidget>("Reel");
